        ...
        <>
            ...
            >
                <Typography
                    ...
                    sx={{marginBottom: 5}}
                >
                    Na Hard Barber Shop, o bem-estar e a satisfação dos nossos clientes são o nosso objetivo.
                </Typography>
                <Typography
                    color='white'
                    variant="body1"
                    sx={{marginBottom: 5}}
                >
                    Com uma equipa de 7 barbeiros altamente qualificados, estamos prontos para oferecer o melhor atendimento e garantir que cada cliente receba o cuidado personalizado que merece.
                </Typography>
                <Typography
                    color='white'
                    variant="body1"
                ...
                >
                    Nossa ampla equipe facilita a marcação de horários, oferecendo mais flexibilidade e garantindo que você esteja sempre no seu melhor para qualquer ocasião. Cada um dos nossos barbeiros é especializado nas técnicas mais avançadas e nas últimas tendências de estilo masculino. Abaixo, você pode conhecer um pouco mais sobre a nossa equipe e segui-los nas redes sociais para acompanhar o trabalho impecável que realizamos todos os dias.
                </Typography>
